package activetech.base.process.context;
...
public class Config {
	 ...
	 */
	public static final String PAGE_PATH_BUSINESS = "/hospital";
	...
	/**
	 * 疾病控制中心存放页面路径 ，在/WEB-INF/jsp下
	 */
	public static final String PAGE_PATH_EDPC = "/edpc";
