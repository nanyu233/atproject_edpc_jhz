...
public class View {
	...
	/**
	 * 返回胸痛中心模块jsp路径方法，其它模块可照此添加
	 * 
	 * @param page
	 *            jsp文件名
	 * @return
	 */
	public static String toEDPC(String page) {
		return Config.PAGE_PATH_EDPC + page;
	}
	...
	/**
	 * 返回rfid模块jsp路径方法，其它模块可照此添加
	 *
	 * @param page
	 *            jsp文件名
	 * @return
	 */
	public static String toRfid(String page) {
