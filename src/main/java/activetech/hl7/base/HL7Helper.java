...
public class HL7Helper {
    ...
    /**
     * 自定义添加AbstractSegment类的字段类型，然后可以用getFeild方法进行赋值,
     * @param obj AbstractSegment对象
     * @param c 数据类型
     * @param required 是否必填
     * @param maxReps  数组长度
     * @param length 字节长度
     * @param constructorArgs  构造器
     * @param name 字段名
...
//    }
     ...
     * @param msg Message类型，如ADT_A01
     * @param hl7str HL7协议报文
     * @throws HL7Exception
     */
     ...
     * 获取Message里面的数据
     * @param msg Message类型
     * @param struIndex AbstractSegment数组位，比如PID有重复多个的话需要自己设置位置，默认传0进去
     * @param segName AbstractSegment名，如PID、MSH等
     * @param ints 具体位置，如new int[]{3,2,3}
     * @return
     * @throws HL7Exception
     */
