...
//		List<HspFuvDocInf> hspFuvDocInfs = followUpService.queryFuvDoc(hspFuvInfQueryDto);
		List<AidEptGrpCustom> grpList = ondutyService.getExpertGrpList();
		List<AidEptGrpCustom> docList = ondutyService.getExpertDocList();
...
//		mapList.put("nxtFuvGrpArr", hspFuvGrpInfs);
		mapList.put("fuvDocArr", docList);
		mapList.put("nxtFuvDocArr", docList);
		mapList.put("fuvGrpArr", grpList);
		mapList.put("nxtFuvGrpArr", grpList);
