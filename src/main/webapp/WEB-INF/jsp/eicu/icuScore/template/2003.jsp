...
<div>
	<div>
		<ul class="maintext">
			...
			<li>
				<p>
					[术中的可能意外和风险：1.造影剂过敏或损伤，导致休克、视力障碍、静脉炎、多脏器功能衰竭以及脱发等；2.血管破裂，造成脑出血，致瘫痪、失语、昏迷、癫痫、死亡等。3.操作部分及相关部分血管痉挛、动脉夹层、斑块脱落、空气栓塞，导致相关部位功能缺失，甚至瘫痪、失语、昏迷、死亡等。4.使用肝素等抗凝药物，造成凝血机制障碍，出血可能。介入材料在血管内可能诱发血栓，造成脑及其他脏器的梗塞。5.导管折断、导丝扭结，可能需手术取出或终身带管，同时需终生服用抗凝药物。6.栓塞材料造成误栓，造成正常血管闭塞，发生相应脑缺氧症状，导致脑梗死可能。出现意外情况改为手术可能。7.血管扭曲或严重痉挛等导致导管、球囊无法到位，手术失败。
					<br>
					术后可能风险：1.瘘口栓塞不全、残留，术后可能复发，需要定期随访，必要时再次治疗。2.穿刺部位血肿、假性动脉瘤或者动静脉瘘行程，穿刺下肢血管痉挛、狭窄、血栓形成导致下肢缺血，可能需要进一步处理或手术治疗。3.手术不成功仍需承担所需费用，出现意外积极抢救所产生费用患者承担。4.有手术中死亡可能，有术后症状加重可能。]
				</p>
			</li>
			<li class="firstli">
