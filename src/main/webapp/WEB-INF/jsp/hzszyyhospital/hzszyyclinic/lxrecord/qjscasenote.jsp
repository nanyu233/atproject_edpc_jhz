...
<head>
  ...
  <script type="text/javascript">
    ...
    var emgSeqNote = '${hspemginfCustom.emgSeq}',
        _lqblSeq_his = '${lqblSeq}'; // 历史病历 留抢病历 seq
  </script>
</head>

<body class="easyui-layout lay-box-small">
  ...
  <script type="text/javascript">
    ...
    var noHisObj = {'requestSource': '${requestSource}', 'cstNam': '${hspemginfCustom.cstNam}', 'mpi': '${hspemginfCustom.mpi}', 'jzxh': '${hspemginfCustom.jzxh}'};
    // 左侧菜单List data
    function getDataMenu() {
      //requestSource 请求来源(HIS_NO_PATIENT: HIS请求病历且未查到患者数据)
      var  _yzUrl = '', _jyUrl = '', _jcUrl = '';
      if ('HIS_NO_PATIENT' == '${requestSource}') {
        _yzUrl = 'hisMedical/toquerycfxx_HIS.do?emgSeq=' + emgSeqNote + '&pageFlag=1&requestSource=' + noHisObj.requestSource + '&cstNam=' + noHisObj.cstNam + '&mpi=' + noHisObj.mpi;
        _jyUrl = 'hisMedical/toqjscaseexaminenew_HIS.do?emgSeq=' + emgSeqNote + '&pageFlag=1&requestSource=' + noHisObj.requestSource + '&cstNam=' + noHisObj.cstNam + '&mpi=' + noHisObj.mpi;
        _jcUrl = 'hisMedical/qjsjcbg_HIS.do?emgSeq=' + emgSeqNote + '&pageFlag=1&requestSource=' + noHisObj.requestSource + '&cstNam=' + noHisObj.cstNam + '&mpi=' + noHisObj.mpi;
      } else {
        _yzUrl = 'zyylqbl/toquerycfxx.do?emgSeq=' + emgSeqNote + '&pageFlag=1';
        _jyUrl = 'zyyqjs/toqjscaseexaminenew.do?emgSeq=' + emgSeqNote;
        _jcUrl = 'zyyqjs/qjsjcbg.do?emgSeq=' + emgSeqNote;
      }
      var data = [{
        text: '急诊门诊病历',
        cod: '1',
        checkName: 'checkMzLqblCod',
        visual: 'block',
        attributes: {
          url: 'hzszyyjzmz/querymzbl.do?emgSeq=' + emgSeqNote + '&requestSource=' + noHisObj.requestSource + '&cstNam=' + noHisObj.cstNam + '&mpi=' + noHisObj.mpi + '&jzxh=' + noHisObj.jzxh
        }
      }, {
        text: '医嘱信息',
        cod: '9',
        ...
        text: '知情同意',
        cod: '8',
        checkName: 'checkMzZqtyCod',
        visual: 'block',
        attributes: {
          url: 'zyyconsent/queryConsentInf.do?refseqno=' + emgSeqNote
        }
      },];
      return data;
    }
    ...
    function checkWay() {
      ...
      if (userFlg == 1 || userFlg == 2) {
        ...
        if (userFlg == 1) { // 护士
          ...
          _checkMenuList = ['checkMzLqblCod', 'checkLqblCod', 'checkBcjlCod', 'checkSsczCod', 'checkHzjlCod', 'checkSwjlCod', 'checkCgjlCod', 'checkMzZqtyCod', 'checkJyxxCod', 'checkJcbgCod', 'checkPfbCod']; // 医生时 除了[护理记录单、体温单、医嘱信息、护理评估单]
        }
        ...
        var _checkOtherMenuList = ['checkMzLqblCod', 'checkLqblCod', 'checkBcjlCod', 'checkSsczCod', 'checkHzjlCod', 'checkSwjlCod', 'checkCgjlCod', 'checkMzZqtyCod', 'checkJyxxCod', 'checkJcbgCod', 'checkPfbCod']; // 医生时 除了[护理记录单、体温单、医嘱信息、护理评估单]
    ...
    function checkZjNurse(_timeVal) {
      ...
      publicFun.httpServer({ url: '${baseurl}zyyqjs/getCheckCase.do', isNoLoad: true }, { emgSeq: emgSeqNote }, function (res) {
        var _checkNurStatus = '';
        var _num = 0;
    ...
    **/
    function setCheckBtnBg() {
      ...
      if (userFlg == 1) { // 护士
        ...
        key_list = ['checkMzLqblCod', 'checkLqblCod', 'checkBcjlCod', 'checkSsczCod', 'checkHzjlCod', 'checkSwjlCod', 'checkCgjlCod', 'checkMzZqtyCod', 'checkJyxxCod', 'checkJcbgCod', 'checkPfbCod']; // 医生时 除了[护理记录单、体温单、医嘱信息、护理评估单]
      }
    ...
    function toIfream(url, indx) {
      $('#mainIfream').attr('src', '${baseurl}' + encodeURI(url));
    ...
    function knowledgeBoxLeft() {
      createmodalwindow('电子病历知识库', 820, 610, '${baseurl}favorite/toKnowledgeBase.do?emgSeq=' + emgSeqNote, 'no');
    }
  </script>
</body>
