...
<head>
    ...
    <script src="${baseurl}js/subpageJs/hzszyyhospital/editxtpg.avalon.js?5" type="text/javascript"></script>
...
<body class="queryxtpg" ms-controller="queryxtpg">
    <form id="userform" action="${baseurl}zyyxtpg/editxtpgsubmit.do" method="post">
        <input class="hidden" type="text" name="hspemginfCustom.emgSeq" value="${hspemginfCustom.emgSeq}">
        <input class="hidden" type="text" name="hspXtpgInfCustom.xtpgSeq" value="${xtpgSeq}">
        <div class="topPart">
        ...
        <!-- <jsp:include page="/WEB-INF/jsp/hzszyyhospital/hzszyyxtpg/FalloutbedGdeOld.jsp"></jsp:include> -->
        ...
        <textarea class="bigDataDiv" id="bigDataDiv" name="hspXtpgInfCustom.xtpgJlhz" ms-duplex-string="systemtMsg.xtpgJlhz" style="display: block;" />
        </textarea>
        <div class="buttonGrp">
            <a class="easyui-linkbutton" iconcls="icon-ok" id="save" onclick="postSystemMsg()">保存</a>
            <!-- <a class="easyui-linkbutton" iconcls="icon-ok" onclick="connectFieldbig()">重新生成汇总记录</a> -->
        </div>
    </form>
