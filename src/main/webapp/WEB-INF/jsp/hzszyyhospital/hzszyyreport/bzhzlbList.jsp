  ...
  <script type="text/javascript">
    ...
    function changeUrl(){
    	...
    	if(pageName == 'bzjczjstj'){
    		datagridUrl = '${baseurl}zyyreport/getbztjmx.do';
    		exportUrl = '${baseurl}zyyreport/bzhzlbExport.do';   	
    	}
    	//统计报表-护士站病种统计
    	else if(pageName == 'hszbztjhzmx'){
    		datagridUrl = '${baseurl}zyyreport/gethszbztjmx.do';
    		exportUrl = '${baseurl}zyyreport/hszbzhzlbExport.do';
    	}
    }
  </script>
  <form>
