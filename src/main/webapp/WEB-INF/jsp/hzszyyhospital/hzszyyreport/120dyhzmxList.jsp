...
<body class="queryjzjl">
  <script type="text/javascript">
    ...
    function generateParam() {
      var _lqVal = '', _hosVal = '',_deadVal = '',_checkStatus = '',key = '';
      ...
      var param = {
        ...
        'hspemginfCustom.iszyFlg': _checkStatus
      }
      if (queryType == 'jsy') {
      	  key = 'hspemginfCustom.abnDriver'  
	  } else if (queryType == 'ys') {
		  key = 'hspemginfCustom.abnDoctor';
	  }
      var value = $('#emgText1').val();
      param[key] = value;
      return param;
    }
	...
	function setTimeForDetail(today){
        ...
        if(queryType== 'year' || queryType =='halfyear' || queryType == 'range'){
        	if(pageName == 'gjhzblhzlb' || pageName == '120dytj'){
    ...
    /**
      ...
      */
    function changeUrl(){
    	//统计报表-病种及其操作技术统计-病种查询
    	if(pageName == '120dytj'){
    		datagridUrl = '${baseurl}zyyreport/getdytjmx.do';
    		exportUrl = '${baseurl}zyyreport/dytjhzlbExport.do';   	
    	}
    }
  </script>
  <form>
    <div class="form clr">
      ...
      <p class="form-text" id="queryType"></p>
      <input id="emgText1" type="text" class="input-wth" onchange="getDataGrid()">
      <p class="line-p-text form-text">
        <input id="checkRecord1" type="checkbox" class="m-t5 isCheckRecord" onchange="getDataGrid()">
        <label for="checkRecord1">住院&emsp;</label>
      </p>
