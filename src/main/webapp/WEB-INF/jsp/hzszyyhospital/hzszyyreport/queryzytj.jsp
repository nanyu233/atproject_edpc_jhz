  ...
  <script type="text/javascript">
    ...
    function init() {
      $('#zglist').datagrid({
        ...
        striped: true,
        singleSelect: true,
        url: '${baseurl}report/queryzhuan_result.do',
        idField: '1',
        loadMsg: '',
        columns: columns_v,
        toolbar: toolbar_v,
    ...
    function cmdexport() {
      ...
      _confirm('确定导出吗？', null, function () {
        publicFun.httpServer({ url: '${baseurl}report/queryzhuanSubmit.do' }, { 'startDate': startTime, 'endDate': endTime }, function (res) {
