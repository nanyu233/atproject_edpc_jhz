...
<head>
  ...
  <title>抢救措施患者明细列表</title>
  <script type="text/javascript">
  	var pageName = '${pageName}';
  	var datagridUrl = '${baseurl}zyyreport/getqjcshzmx.do';
  	var exportUrl = '${baseurl}zyyreport/qjcstjlbSubmit.do';
  	var type;
  </script>
</head>
...
<body class="queryjzjl">
  <script type="text/javascript">
    ...
    function generateParam() {
      ...
      var param = {
        ...
        'hspemginfCustom.bzName': $('#emgText3').val()
      }
      return param;
    }
    ...
    function setTime(type,format) {
     ...
     || pageName == 'gjhzswlhzlb' || pageName == '120patient' || pageName == 'hszbztjhzmx' || pageName == 'bzjczjstj' || pageName == 'qjcshzmx'){
	  	setTimeForDetail(today);
	  	setOptionForList();
	  }else{
	  	$("#startdate_range").val(today);
      	$("#enddate").val(today);
	  }
    };
	...
	function setTimeForDetail(today){
        ...
        if(queryType== 'year' || queryType =='halfyear' || queryType == 'range'){
        	if(pageName == 'qjcshzmx' || pageName == 'bzjczjstj'){
        	...
        	today = publicFun.timeFormat('${startdate}', format);
	  		...
	  		console.log(type)
	  		console.log(today)
	  		console.log($("#startdate_month").val())
      		$("#enddate").val(today);
        }
    }
  ...
  <form>
    <div class="form clr">
      <select id="chooseType" name="querytype" class="hidden">
      </select>
