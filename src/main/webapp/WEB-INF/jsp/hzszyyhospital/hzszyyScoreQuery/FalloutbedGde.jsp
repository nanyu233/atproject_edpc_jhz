...
<body class="scoreQuery" ms-controller="falloutBed">
  <p class="headtitle">坠床跌倒评分</p>
  <jsp:include page="/WEB-INF/jsp/hzszyyhospital/hzszyyScoreQuery/basicTopInfo.jsp"></jsp:include>
  <div class="panelGde">
    <form id="falloutForm" action="${baseurl}scorequery/addFalloutbedScore.do" method="post">
      <input class="hidden" type="text" value="${emgSeq}" name="hspZcddexpfInfCustom.emgSeq">
      <input class="hidden" type="text" value="${xtpgSeq}" name="hspZcddexpfInfCustom.xtpgSeq">
