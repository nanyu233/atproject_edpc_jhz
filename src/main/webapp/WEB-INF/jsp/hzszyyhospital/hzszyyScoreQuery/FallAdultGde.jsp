...
<body class="winScore">
  <div class="scoreQuery" ms-controller="fallDanger">
    ...
    <form id="falloutForm" action="${baseurl}scorequery/addFallRisk.do" method="post">
      ...
      <input class="hidden" type="text" name="hspFallriskInfCustom.fallRiskFlg" value="2">
        ...
        <div class="DangerContent panelContent">
          ...
          <ul class="tableUl paneltab">
            ...
            <li>
              ...
              <span class="titleSpan spcLine">使用高跌倒风险的药物：包括止<span>痛泵/麻醉剂，</span><span class="showKdx">抗癫痫药，</span><span
                  class="showKy">抗压药，</span><span class="showLn">利尿剂，</span><span class="showCm">催眠药，</span><span class="showXy">泻药，</span><span
                  class="showZdj">镇定剂</span><span class="showJs">和精神药物</span>（单选）</span>
            ...
            <li class="fourLi">
              ...
              <label ms-repeat="systemList.riskOcognizeCodList" ms-attr-for="riskOcognizeCod{{el.infocode}}" class="labtab evenLab">
                ...
                <span class="fourthSpan">{{el.info}}</span>
                <span class="thirdSpan">
                  <input ms-attr-id="riskOcognizeCod{{el.infocode}}" type="checkbox" ms-attr-checked="el.checked"
                    ms-click="otherCheckClick('riskOcognizeCod',$index,'aboutFallDanger')">
                </span>
              </label>
