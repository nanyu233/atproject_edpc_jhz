...
<body>
  <div class="edithlpgb tabhzdj">
    <div class="sub-title">
      护理评估单
    </div>
    <div class="edit-div" onclick="toggleedit()">
      <i class="isFinish" ms-class="active:vm.patientInfFlg.pgbFlag===1||vm.patientInfFlg.pgbFlag==='1'" ms-visible="sub.hlpgbpatientMsg.pgbFlag==1">{{vm.patientInfFlg.pgbMsg}}</i>
  ...
  <div ms-controller="queryhlpgb" class="queryhlpgb">
    ...
    <ul class="content-ul">
      ...
      <li ms-visible="sub.hlpgbpatientMsg.zsFlag==1">
    ...
    <ul class="content-ul" ms-visible="sub.hlpgbpatientMsg.zsFlag==1">
      <p class="subtitle">
    ...
    <textarea ms-visible="sub.hlpgbpatientMsg.zsFlag==1" ms-duplex-string="hlpgbpatientMsg.symSitDes" class="bigDataHlpgDiv"
      id="bigDataHlpgDiv" name="hspemginfCustom.symSitDes" /></textarea>
    <div class="buttonGrp">
