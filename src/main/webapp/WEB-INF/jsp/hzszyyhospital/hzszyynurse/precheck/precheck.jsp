...
<body class="jsbrqjs">
  <form ms-controller="jsbrqjs" id="userform" action="${baseurl}hzszyyemg/addzyyemgsubmit_yjfz.do" method="post" style="font-size: 12px;display: block;">
    ...
    <div class="container-fluid clr head">
      ...
      <div class="basic-msg-container">
        ...
        <div class="display-table basic-msg">
          ...
          <div class="display-table-cell">
            <input class="phone-number" type="text" name="hspemginfCustom.pheNbr" placeholder="联系方式" ms-duplex-string="patientMsg.pheNbr" maxlength="30"
    ...
    <div class="container-fluid clr">
      <div class="patient-msg-container">
        <div class="display-table">
          ...
          <div class="display-table-cell clr container-wth middleAlign">
          ...
          <div class="display-table-cell clr container-wth middleAlign">
            <label ms-repeat="getMsg.cardTypeList" ms-attr-for="cardType{{el.infocode}}">
        ...
        <div class="display-table" ms-visible="patientMsg.grnChl==1 || patientMsg.qtsjFlg==1">
        ...
        <div class="patient-msg-container">
          <div class="display-table arrive-hosptial-msg">
            <div class="arrive-type-container">
              <div class="display-table-cell form-text text-right six-text" ms-class="required-fields: (hideMsg.ksfz == '' && patientMsg.patientTyp !== '2')">
                <i class="red" ms-visible=" hideMsg.ksfz == '' && patientMsg.patientTyp !== '2'">*</i>
                到院方式：
              </div>
              <div class="display-table-cell clr">
        ...
        <div class="patient-msg-container">
          <div class="display-table arrive-hosptial-msg">
            <div class="arrive-type-container">
              ...
              <div class="display-table-cell middleAlign container-wth clr">
        ...
        <div class="display-table">
          ...
          <div ms-visible="isShowBed()" class="display-table-cell clr middleAlign">
        ...
        <div ms-visible="patientMsg.cstSexCod === '1'" class="display-table min-line-height">
          <div class="display-table-cell form-text text-right min-line-height six-text" ms-class="required-fields:( hideMsg.ksfz == '' && patientMsg.patientTyp !== '2') ">
            <i class="red" ms-visible=" hideMsg.ksfz == ''  && patientMsg.patientTyp !== '2'">*</i>
            女性月经史：
          </div>
          <div class="display-table-cell">
            ...
            <i ms-visible=" patientMsg.mnsSitCod== '1' ">第 <input type="text" name="hspemginfCustom.caseHis" class="iptbox" ms-duplex-string="patientMsg.caseHis"
              ms-keyup="onlyNum('patientMsg','caseHis',1,100)" ms-input="onlyNum('patientMsg','caseHis',1,100)" ms-change="onlyNum('patientMsg','caseHis',1,100)" > 周</i>
          </div>
        </div>
        <div class="middleLabel">
          <div class="display-table-cell form-text text-right middleLabel six-text" ms-class="required-fields: (hideMsg.ksfz == '' && patientMsg.patientTyp !== '2' )">
            <i class="red" ms-visible=" hideMsg.ksfz == '' && patientMsg.patientTyp !== '2' ">*</i>
            过敏史：
          </div>
          <div class="display-table-cell">
    ...
    <div class="container-fluid btnDiv" style="text-align: center;">
  ...
  <script type="text/javascript">
    ...
    function postPatientMsg(print) {
      ...
      if (allPostMsg.abnSco != "" && allPostMsg.fullAdd == "") {
