<div id="s2011">
	...
	<div ms-controller="timeRecord">
		...
		<p class="functype" id="id_title2">${hospitalPlatformName}胸痛时间管理表</p>
		<div>
			...
			<li class="infoli">
					...
					<label>住院ID:</label>
					<input type="text" class=" intextinputlong" value="${hspHlpgb.qxZyh}">
			...
			<table class="managetable maintext2 borderTable">
				...
				<tr>
					<td colspan="1">
						<label>姓名：</label>
						<input type="text" class="intextinputlong" style="width: 100px;" value="${hspemginfCustom.cstNam}" />
					</td>
				...
				<tr>
					<td colspan="2">
						...
						<input class="Wdate spcWdate thindate" type="text" readonly="readonly" onclick="WdatePicker({dateFmt:'dd日 HH:mm'})">
					</td>
					<td colspan="4">
				...
				<tr>
					...
					<td colspan="1">
						<label style="font-weight: 700">传输时间:</label>
						<input class="Wdate spcWdate thindate" type="text" readonly="readonly" onclick="WdatePicker({dateFmt:'dd HH:mm'})">
						
					</td>
					<td colspan="3">
						<label style="font-weight: 700">传输方式:</label>
						<label class="checklabel">
...
-->
		...
		<table class="managetable maintext2 borderTable"> -->
			...
			<tr>
				...
				<tr>
					<td colspan="6">
						...
						(
							...
							<label>床位医师接触时间：</label>
							<input class="Wdate spcWdate thindate illHspInput" type="text" readonly="readonly" onclick="WdatePicker({dateFmt:'MM/dd HH:mm'})" onkeyup="isText('illHsp')">;
							<label>患者离开科室时间：</label>
							<input class="Wdate spcWdate thindate illHspInput" type="text" readonly="readonly" onclick="WdatePicker({dateFmt:'MM/dd HH:mm'})" onkeyup="isText('illHsp')">
						)
				...
				<tr>
					<td colspan="5">
						<label style="font-weight: 700">生命体征:</label>
						<label>意识</label>
						<label class="checklabel">
						...
						<input type="text" class="intextinput" onkeyup="exchangeToNum(this)"/>mmHg
						<label>体温:</label>
						<input type="text" class="intextinput" onkeyup="exchangeToNum(this)"/>℃
					</td>
				</tr>
		...
		<!-- -------------------------------------------我是分割线 ------------------------------------------------------------->
				...
				<tr>
					<td colspan="2">
						...
						<input class="Wdate spcWdate thindate" type="text" readonly="readonly" onclick="WdatePicker({dateFmt:'HH:mm'})">
					</td>
					<td colspan="2">
					...
					<td rowspan="17" colspan="4" style="line-height: 3;font-size: 12px">
						<label style="font-weight: 700">由实际判定或实施人员勾选:</label>
						<br>
						<label style="font-weight: 700">Killip 分级:</label>
						<label class="checklabel">
				...
				<tr>
					<td colspan="4">
						...
						<input class="Wdate spcWdate thindate" type="text" readonly="readonly" onclick="WdatePicker({dateFmt:'HH:mm'})">
						<input type="text" class="intextinput" onkeyup="exchangeToNum(this)"/>ng/ml;
					</td>
				</tr>
				
				<tr>
					<td colspan="4">
						<label style="font-weight: 700">实验室检查:Cr:</label>
						<input type="text" class="intextinput" onkeyup="exchangeToNum(this)"/>;&nbsp;
						<label style="font-weight: 700">D-dimer:</label>
						<input type="text" class="intextinput" onkeyup="exchangeToNum(this)"/>;&nbsp;
						<label style="font-weight: 700">BNP/NT-proBNP:</label>
						<input type="text" class="intextinput" onkeyup="exchangeToNum(this)"/>
					</td>
				</tr>
				...
				<tr>
					<td colspan="4">
						<label style="font-weight: 700">辅助检查:</label>
...
<!-- ------------------------------------我是分割线-------------------------------------- -->
				...
				<tr>
					<td colspan="2">
						<label style="font-weight: 700">复测心电图时间:</label>
						<input class="Wdate clockdate" type="text" readonly="readonly" onclick="WdatePicker({dateFmt:'HH:mm'})">
				...
				<tr>
					<td colspan="4">
						<label style="font-weight: 700">PCI血管路径:</label>
						<label class="checklabel">
				...
				<tr>
					...
					<td colspan="1">
						<label style="font-weight: 700">阻塞性病变:</label>
						<label class="checklabel">
				...
				<tr>
					...
					<img style="float: left" src="../images/hzszyyhems/nurse/dgs.png">
				...
				<tr>
					<td colspan="1">
						<p>拓展项：<br>16:中间支 17:第三对角支 18:第二钝缘支19:
				...
				<tr>
					<td colspan="1">
						...
						<br>
						<label>术前TIMI</label>
						<input type="text" class="intextinputlong" />级、
						<br>
						<label>术后TIMI</label>
						<input type="text" class="intextinputlong" />级;
						<br>
				...
				<tr>
					<td colspan="1">
						...
						<input type="text" class="intextinput" onkeyup="exchangeToNum(this)"/>分钟
					</td>
					<td colspan="3">
						<label>是否延误:</label>
						<label class="checklabel">
				...
				<tr>
					...
					<td colspan="1">
						...
						<input type="text" class="intextinput" onkeyup="exchangeToNum(this)"/>%(最低值)
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="2">
						<label>住院天数:</label>
						<input type="text" class="intextinput" onkeyup="exchangeToNum(this)"/>天
					</td>
					
					<td colspan="1">
						<label>总费用:</label>
						<input type="text" class="intextinput" onkeyup="exchangeToNum(this)"/>元
					</td>
				</tr>
