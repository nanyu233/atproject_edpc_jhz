<div id="s2017">
		...
		<div>
			...
			<p class="functype" id="id_title2">洗胃谈话记录</p>
			<div>
				<ul class="maintext">
					<li>
						<p>患者因病情需要，需洗胃，在洗胃过程中及其后可能存在以下风险：</p>
						...
						<p>以上情况严重时可危及生命，医务人员将严格按照操作规范进行操作，并做好相应的防范和抢救措施，力
							争将风险降低到最低限度，出现意外及时处理，但风险客观存在不可能完全避免。以上事项已详细告知家属，
							家属对可能不良后果表示充分理解，签字如下：
						</p>
					</li>
					<li class="firstli">
						<span>
					...
					<li class="firstli">
						<span>
						<label class="lonefont">与患者关系：</label>
						<span><input type="text" class="intextinputlong"/></span>
						</span>
					</li>
					<li class="firstli">
