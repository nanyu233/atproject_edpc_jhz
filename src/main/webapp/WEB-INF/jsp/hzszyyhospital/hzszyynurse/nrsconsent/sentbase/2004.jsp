				...
				<ul class="maintext">
					...
					<li>
						<label>
							...
							术取出或终身带管，同时需终生服用抗凝药物。6.根据动脉瘤形状、位置等决定具体手术方案，如为宽颈，或梭形动脉瘤，
							必须采用支架或球囊辅助栓塞术，支架可能无法到位，支架移位或塌陷，血管闭塞可能，造成神经功能缺失，出现生命危险。
							7.弹簧圈突入载瘤动脉，造成血管闭塞，发生相应脑缺血症状，导致脑梗死可能。出现意外情况改为手术可能。8.血管扭曲
							或严重痉挛等导致微导管、球囊或支架无法到位，手术失败。9.可能合并多发脑动脉瘤可能，由此手术风险加大，费用增加。
							<br/>
							术后可能风险：1.动脉瘤栓塞不全、瘤颈残留，术后可能复发，需要定期随访，必要时再次治疗。2.蛛网膜下腔出血造成病
							情危重，术后昏迷不醒死亡可能。3.穿刺部位血肿、假性动脉瘤或动静脉瘘行程，穿刺侧下肢血管痉挛、狭窄、血栓形成导
							致下肢缺血，可能需要进一步处理或手术治疗。4.手术不成功仍需承担所需费用，出现意外积极抢救所产生的的费用由患者
							承担。5.有手术中死亡可能，有术后症状加重可能。]
						</label>
					</li>
					<li class="firstli">
