		...
		<ul class="maintext">
			...
			<li>
				<label>
					...
					器功能衰竭以及脱发等；2.造成脑出血，致瘫痪、失语、昏迷、癫痫、死亡等；3.操作部
					位及相关部位血管痉挛、动脉夹层、斑块脱落、空气栓塞，导致相关部位功能缺失，甚至
					瘫痪、失语、昏迷、死亡等；4.使用肝素等抗凝药物，造成凝血机制障碍，出血可能。介
					入材料在血管内可以诱发血栓，造成脑及其他脏器的梗塞；5.导管折断、导丝扭结，可能
					需手术取出或终身带管，同时需终生服用抗凝药物；6.支架脱落、打开不全，局部血栓形
					成、血栓脱落导致脑梗塞，导致严重残疾甚至死亡；7.血管撕裂损伤，造成局部出血，导
					致休克、梗塞、甚至危及生命；8.血管扭曲或严重痉挛等导致微导管、支架无法到位，手
					术失败。<br>
					术后可能风险：1.术后支架移位、再狭窄，需再次手术可能；2. 穿刺部位血肿、假性动脉
					瘤或动静脉瘘形成，穿刺侧下肢血管痉挛、狭窄、血栓形成导致下肢缺血，可能需要进一
					步处理或手术治疗；3. 手术不成功仍需承担所需费用，出现意外积极抢救所产生费用由患
					者承担；4.术后需长期双联（一年）抗血小板治疗，发生颅内外出血风险增加，严重时有
					导致病人死亡等可能。 ]
				</label>
			</li>
			<li class="firstli">
			...
			<li>
				<label class="sectiontitle">
					我的医师已经告知我将要进行的治疗方式必要性、步骤、成功率、治疗及治疗后可能发生
					的风险和并发症、不实施该医疗措施的风险，操作中或操作后可能发生疼痛，及产生疼痛
					后的治疗措施，我经慎重考虑，已充分理解本知情同意书的各项内容，愿意承担由于疾病
					本身或现有医疗技术所限而致的医疗意外和并发症，并选择本治疗(而非替代方案中的治
					疗方案)。
				</label>
			</li>
			<li class="inputli">
			...
			<li class="firstli">
				<table class="hdtable hdtable-fy">
					<tr>
