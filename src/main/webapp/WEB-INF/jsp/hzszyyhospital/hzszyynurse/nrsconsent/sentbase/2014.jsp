<div id="s2014">
		...
		<div>
			...
			<p class="functype" id="id_title2">气管插管和机械通气知情同意书</p>
			<div>
				<ul class="maintext">
					<li >
						<span>
							<label class="sectiontitle">患者姓名：</label>
							<input type="text" class="intextinputlong" value="${hspemginfCustom.cstNam}">
						</span>
						<span>
							<label class="sectiontitle">性别：</label>
							<input type="text" class="intextinputlong" value="${hspemginfCustom.cstSexCod}">
						</span>
						<span>
							<label class="sectiontitle">年龄：</label>
							<input type="text" class="intextinputlong" id="cstage">
						</span>
					</li>
					<li >
						<label class="sectiontitle"><p>疾病介绍和治疗建议</p></label>
						<label>
							<p class="indenttwo">
								医生已告知患者有<input type="text" class="intextinputlong"/>,需要进行气管插管和机械通气。机械通气的目的：改善呼吸功能，维持生命体征，为解除诱发加重因素争取时间。
							</p>
						</label>
					</li>
					<li >
						<label class="sectiontitle"><p>手术潜在风险和对策</p></label>
						<label>
							<p class="indenttwo">
								医生告知患者气管插管和机械通气可能发生的一些风险，有些不常见的风险可能没有在此列出，
								具体的操作根据不同病人的情况有所不同，医生已告知患者及家属可与患者的医生讨论有关患者操
								作的具体内容，如果有特殊的问题可与患者的医生讨论。									
							</p>
							<p class="indenttwo">
								1．我理解任何麻醉都存在风险。
							</p>
					...
					<li >
						<label class="sectiontitle" ><p>特殊风险或主要高危因素</p></label>
						<label>
							<p class="indenttwo">
								我理解根据我个人的病情，可能出现以下特殊的并发症或风险：
								<textarea id="areavalue" class="pretextarea qtmargin showym"></textarea><span id="spanvalue" class="prespan qtmargin showdy"></span>							
							</p>
							<p class="indenttwo">
					...
					<li >
						<label class="sectiontitle" ><p>患者知情选择</p></label>
