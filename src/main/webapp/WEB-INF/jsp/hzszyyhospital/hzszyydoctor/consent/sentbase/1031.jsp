	...
	<div class="messages m_t10">
		<div style="border: 0px">
			<table class="tbody">
				...
				<tr>
					<td colspan="5">
						<label id="id_7" class="labtitle">目前诊断（Current Diagnosis）：</label>
						<input id="value_7" type="text" class="input_txt" style="width: 150px;"/>
					</td>
				</tr>
				<tr>
					<td colspan="5">
						<label id="id_8" class="labtitle">诊断操作目的（Purposes）：</label>
				...
				<tr>
					<td colspan="5">
						<label id="id_9" class="labtitle">主要意外、风险及并发症（Major Accidents,Risk Factors and  Compliactions）：</label>
					</td>
				</tr>
				<tr>
					<td colspan="5">
						<textarea class="hugeArea" id="id_10">术中的可能意外和风险：1.造影为检查手段，若确认大动脉血栓，需要进行颅内动脉取栓术；若血管痉挛或其他原因导致导管手术失败，但仍需承担相应费用。2.造影剂过敏或损伤，导致休克、视力障碍、静脉炎、多脏器功能衰竭等。3.造成脑出血，致瘫痪，失语，昏迷，癫痫，死亡等。4.使用肝素等抗凝药物，造成凝血机制障碍，出血可能，造影器材在血管内科诱发血栓，造成脑及其他脏器的梗死。5.术前、术中动脉瘤破裂可能，血管穿孔或血管壁撕裂，造成脑出血或发生休克、死亡。6.血管痉挛，动脉夹层、血管内斑块脱落、空气栓塞，导致脑缺血、脑栓或者脑梗死，致瘫痪、失语、昏迷、癫痫、死亡等。7.导管、导丝操作致心律失常、心跳骤停或导管折断、导丝扭结，可能需手术取出或终身带管，同时需终生服用抗凝药物。8.根据动脉急性闭塞情况决定具体手术方式，如动脉溶栓术，或动脉溶栓+机械取栓术，或单纯去栓术，或严重狭窄予支架植入术。9.脑梗死持续加重，出血意外情况改为手术可能。10.血管扭曲或者严重痉挛等导致微导管，支架无法到位，手术失败。11.术中遇到其他难以预料的情况（包括心肌梗等），造成生命危险。</textarea>	
						<textarea class="hugeArea" id="id_11">术后可能发生的并发症和意外：1.本次病情危重，术后昏迷不醒死亡可能2.术后穿刺部位血肿，假性动脉瘤或动静脉瘤形成，穿刺测下肢血管痉挛、现摘、血栓形成导致下肢缺血，可能需要进一步处理货手术治疗3.手术不成功仍需成大所需费用，出现意外积极抢救所产生费用仍由患者及家属承担4.有手术中死亡可能，有术后症状加重可能5.感染，伤口周围皮肤过敏、破损6.术前无法预见的危及生命的情况。</textarea>
					</td>
				</tr>
				<tr>
					<td colspan="5">
						<label id="id_12" class="labtitle">防范措施（Precaution）：</label>
						<br/>
						<label id="id_13">
						1）严格按照诊疗操作规范执行；
						</label><br/>
				...
				<tr>
					<td colspan="5">
					    ...
					    <input type="radio" name="Alternatives" class="checkStyle1" id="checkbox_5" 
					        ...
					        <label id="id_77" class="doctorType" for="checkbox_5" style="color: blue;">有；</label></input>
						...
						onclick="document.getElementById('value_22').style.display='none';document.getElementById('value_22').value=''">
						<label id="id_78" class="doctorType" for="checkbox_6" style="color: blue;">不确定；</label></input>
						&nbsp;
						&nbsp;
						<input type="radio" name="Alternatives" class="checkStyle1" id="checkbox_7" 
						onclick="document.getElementById('value_22').style.display='none';document.getElementById('value_22').value=''">
						<label id="id_79" class="doctorType" for="checkbox_7" style="color: blue;">无；</label></input>
					</td>
				</tr>
				<tr align="right">
					<td colspan="5">
...
<script type="text/javascript">
	function getText(){
		...
		var lab10 = document.getElementById("id_10").innerHTML;
		var lab11 = document.getElementById("id_11").innerHTML;
