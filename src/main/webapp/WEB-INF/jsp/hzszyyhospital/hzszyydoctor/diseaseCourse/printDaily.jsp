        ...
        <script type="text/javascript">
            function initBaseHtmlDom() {
                ...
                initBaseHtmlDom.push(
                    ...
                    '<p style="margin:2mm 0;padding:0;text-align:center;font-weight:700;font-size:.58cm;">日常病程</p>',
            ...
            function initHtmlDom(row, idx){
                ...
                initHtmlDomList.push(
                    ...
                    '<span style="color:#000;font-weight:bold">日常病程记录：</span>',
                    '</p>',
                    '<p style="margin:0;padding:0;font-size:.38cm;">',
                    '<span style="color:#000;">',row['record'],'</span>',
                    '</p>',
                    '<br/>',
            ...
            function printall(){
                ...
                try {
                    ...
                    var allRows = $('#dailytable').datagrid('getData')['rows'];
