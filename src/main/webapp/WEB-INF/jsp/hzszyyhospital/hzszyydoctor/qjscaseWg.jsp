...
<body class="bottomQjs">
  ...
  <div style="width:100%;height:100%; display:none;font-size: 15" id="print">
    ...
    <ul style=" width: 380px;margin:0px;font-size: 15;font-family:楷体;" align="left">
      ...
      <li>
        <label style="padding-left:10px;">就诊号:</label>
  ...
  <script type="text/javascript">
      ...
      $('#patientList').datagrid({
        ...
        onDblClickRow: function (rowIndex, rowData) {
          ...
          var openTabName = openTabNam + rowData.cstNam + '-留抢病历记录',
            openTabUrl = '${baseurl}zyyqjs/qjscasenote.do?emgSeq=' + rowData.emgSeq + '&th=' + new Date().getTime();
    ...
    function bedItemClick(indx) {
      ...
      var openTabName = openTabNam + checkedObj.cstNam + '-留抢病历记录',
        openTabUrl = '${baseurl}zyyqjs/qjscasenote.do?emgSeq=' + checkedObj.emgSeq + '&th=' + new Date().getTime();
