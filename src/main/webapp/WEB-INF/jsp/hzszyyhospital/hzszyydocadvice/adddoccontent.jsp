...
<body class="adddevice">
    <form class="form" id="docform" action="${baseurl}zyydoc/adddoccontent.do" method="post">
        <table>
            <tbody>
                <tr >
                	<input type="hidden" id="modelSeq" name="modelSeq" value="${modelSeq}" maxlength="280"/>
                    <th > 模板内容：</th>
                    <td >
                        <textarea style="width:350px;height:150px" id="clsCont" name="clsCont" maxlength="280"></textarea>
                    </td>
                </tr>
                <tr>
