...
<body class="adddevice">
    <form class="form" id="modelform" action="${baseurl}zyymodel/addmodel.do" method="post">
        <table>
            <colgroup>
                <col width="23%" />
                <col />
            ...
            <tbody>
                ...
                <tr >
                    ...
                    <td style="height:220px">
                        <textarea style="width:400px;height:220px" id="clsCont" name="clsCont" maxlength="1000"></textarea>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" class="last_td">
                        <div class="center grp_btn">
                            <a class="easyui-linkbutton" iconCls="icon-ok" id="submitbtn" onclick="insertModel()">确定</a>
    ...
    <script type="text/javascript">
        ...
        function insertModel() {
            if (validateForm()) {
                jquerySubByFId('modelform', insertmodel_callback, null, "json");
            }
        }
