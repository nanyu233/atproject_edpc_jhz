...
<body class="editHspUhfTrp">
  <form class="form" ms-controller="editHspUhfTrpForm" id="hspUhfTrpForm" action="rfid/editHspUhfTrpSubmit.do" method="post">
    <input class="hidden" id="edit_trpSeq" name="trpSeq" value="${hspUhfTrpCustom.trpSeq}" />
    <table>
      <colgroup>
        <col width="18%" />
        <col />
        ...
        <tr>
          <td colspan="2" class="last_td">
            <div class="center grp_btn">
              <a class="easyui-linkbutton" iconCls="icon-ok" id="submitbtn" onclick="editHspUhfTrp()">确定</a>
  ...
  <script type="text/javascript" src="${baseurl}js/subpageJs/rfid/editHspUhfTrp.avalon.js"></script>
</body>
