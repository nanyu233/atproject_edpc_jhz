...
<body>
    ...
    <script type="application/javascript">
        ...
        function initUserTable() {
            var info = $(groupSelector).data('selectedRow')
            ...
            var datagridOptions = {
                ...
                onClickCell: function (index, field, value) {
                    if (field === '__handle' && value !== false) {
                        var groupInfo = $(groupSelector).data('selectedRow')
        ...
        function datagridUnselectAbility (context, index, row) {
            ...
            var selectedRow = $(context).data("selectedRow");
            if (selectedRow && selectedRow[idField] === row.grpSeq) {
                $(context).datagrid('unselectRow', index);
                $(context).data("selectedRow", null)
            } else {
                $(context).data("selectedRow", row)
            }
        }
