    ...
    var hzxq = new Vue({
        ...
        data: {
            ...
            sidebar: [
                ...
                {
                    name: '胸痛上报',
                    src: 'cpc/toXtxqPage.do?regSeq=' + '${regSeq}' + '&cstNam=' + '${cstNam}' + '&emgSeq='  + '${emgSeq}' + '&wayTyp=' + '${wayTyp}'
                },
                {
                    name: '诊疗流程',
                    src: 'cpc/toXtHomePage.do?regSeq=' + '${regSeq}' + '&cstNam=' + '${cstNam}' + '&emgSeq='  + '${emgSeq}' + '&wayTyp=' + '${wayTyp}'
                },
                {
                    name: '时间轴',
                    src: '${baseurl}cpc/toCpcTimeline.do?emgSeq='  + '${emgSeq}'+'&wayTyp=' + '${wayTyp}' + '&regSeq=' +'${regSeq}'
                },
                {
                    name: '随访记录',
        ...
        created() {
            if (window.sessionStorage.getItem('currentIframeSrc' + '${regSeq}') && window.sessionStorage.getItem('currentIframeSrc' + '${regSeq}')!=0) {
                this.currentIframeSrc = window.sessionStorage.getItem('currentIframeSrc' + '${regSeq}')
