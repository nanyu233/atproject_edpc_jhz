...
<body class="Overtime">
	<form id="querymqform" action="edpcReport/exportYzcsbrmjzzbRateSubmit.do"
		method="post">
		<!-- html的静态布局 -->
		<!-- 查询条件 -->
		<div class="m-b5">
	...
	<div class="chart_grp chartbox">
		<div class="form_cat border-radius box-shadow">
			<p class="chart_title">严重创伤病人门/急诊准备时间</p>
	...
	<script type="text/javascript">
       ...
       $(document).keydown(function(event) {
        ...
        function datagridshow(){
            ...
            $('#tableId').datagrid({
                title: "严重创伤病人门/急诊准备时间",
                nowrap: true,
                //view: transposedview,
                striped: true,
                singleSelect: true,
                url: "edpcReport/queryYzcsbrmjzzbRate_result.do",
                //idField: '1',
                loadMsg: '',
                queryParams: {
                    startDate: start,
