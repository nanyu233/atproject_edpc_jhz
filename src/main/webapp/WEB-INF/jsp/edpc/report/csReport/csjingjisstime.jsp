...
// 			console.log(queryParams)
    ...
    function getData() {
        $('#tablelist').datagrid({
            title: '紧急手术术前准备时间(严重创伤病人）',
            nowrap: true,
            striped: true,
            singleSelect: true,
            rownumbers: true,
            toolbar: getToolbar(),
            url: '${baseurl}edpcReport/queryCsJingjissTime.do',
...
// 			console.log('seriesData', seriesData)
        series.push(new Series('紧急手术术前准备时间(严重创伤病人）', seriesData))
...
<form id="reportform" action="${baseurl}edpcReport/exportCsJingjissTime.do" method="post">
    <!-- html的静态布局 -->
    <!-- 查询条件 -->
    <div class="m-b5">
...
<div class="chart_grp chartbox" id="chartbox">
    <div class="form_cat border-radius box-shadow">
        <p class="chart_title">紧急手术术前准备时间(严重创伤病人）</p>
        <!-- <hr class="hr"/> -->
