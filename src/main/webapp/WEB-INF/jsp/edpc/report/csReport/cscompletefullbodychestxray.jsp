...
<head>
    <title>到达门/急诊科至完成全身胸部X片的时间</title>
...
// 			console.log(queryParams)
    ...
    function getData() {
        $('#tablelist').datagrid({
            title: '到达门/急诊科至完成全身胸部X片的时间趋势表',
            nowrap: true,
            striped: true,
            singleSelect: true,
            rownumbers: true,
            toolbar: getToolbar(),
            url: '${baseurl}edpcReport/queryCsCompleteFullBodyChestXray.do',
...
// 			console.log('rows', rows);
        ...
        $.each(rows, function(ind, val) {
            ...
            seriesData.push(new SeriesData(val.yarmon, val.total))
        });
// 			console.log('seriesData', seriesData)
        series.push(new Series('到达门/急诊科至完成全身胸部X片的时间', seriesData))
...
<form id="reportform" action="${baseurl}edpcReport/exportCsCompleteFullBodyChestXray.do" method="post">
    <!-- html的静态布局 -->
    <!-- 查询条件 -->
    <div class="m-b5">
...
<div class="chart_grp chartbox" id="chartbox">
    <div class="form_cat border-radius box-shadow">
        <p class="chart_title">到达门/急诊科至完成全身胸部X片的时间趋势图</p>
        <!-- <hr class="hr"/> -->
