...
// 			console.log(queryParams)
    ...
    function getData() {
        $('#tablelist').datagrid({
            ...
            rownumbers: true,
            toolbar: getToolbar(),
            url: '${baseurl}edpcReport/queryCsyzZhuyTime.do',
...
// 			console.log('seriesData', seriesData)
        series.push(new Series('严重创伤病人平均住院时间', seriesData))
...
<form id="reportform" action="${baseurl}edpcReport/exportCsyzZhuyTime.do" method="post">
    <!-- html的静态布局 -->
    <!-- 查询条件 -->
    <div class="m-b5">
...
<div class="chart_grp chartbox" id="chartbox">
    <div class="form_cat border-radius box-shadow">
        <p class="chart_title">严重创伤病人平均住院时间</p>
        <!-- <hr class="hr"/> -->
