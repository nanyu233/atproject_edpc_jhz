...
<body class="Overtime">
	<form id="querymqform" action="edpcReport/exportCsxxyjRateSubmit.do"
		method="post">
		<!-- html的静态布局 -->
		<!-- 查询条件 -->
		<div class="m-b5">
	...
	<div class="chart_grp chartbox">
		<div class="form_cat border-radius box-shadow">
			<p class="chart_title">创伤患者信息预警比例</p>
       ...
       $(document).keydown(function(event) {
        ...
        function datagridshow(){
            ...
            $('#dtoblist').datagrid({
                ...
                striped: true,
                singleSelect: true,
                url: "edpcReport/queryCsxxyjRate_result.do",
                //idField: '1',
                loadMsg: '',
                queryParams: {
                    startDate: start,
                ...
                onLoadSuccess: function(data) {
                	...
                	var dataArray = data.rows;
                        ...
                        for (var i = 0; i < dataArray.length; i++) {
                        	...
                        	seriesData.push(dataArray[i].tnumb);
                        }
                    }
