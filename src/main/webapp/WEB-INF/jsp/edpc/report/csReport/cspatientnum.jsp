...
// 			console.log(queryParams)
    ...
    function getData() {
        $('#tablelist').datagrid({
            ...
            rownumbers: true,
            toolbar: getToolbar(),
            url: '${baseurl}edpcReport/queryCsPatientNum.do',
...
// 			console.log('seriesData', seriesData)
        series.push(new Series('创伤病人数量', seriesData))
...
<form id="reportform" action="${baseurl}edpcReport/exportCsPatientNum.do" method="post">
    <!-- html的静态布局 -->
    <!-- 查询条件 -->
    <div class="m-b5">
