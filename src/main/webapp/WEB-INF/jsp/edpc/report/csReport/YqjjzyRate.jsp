...
<body class="Overtime">
	<form id="querymqform" action="edpcReport/exportYqjjzyRateSubmit.do"
		method="post">
		<!-- html的静态布局 -->
		<!-- 查询条件 -->
		<div class="m-b5">
	...
	<div class="chart_grp chartbox">
		<div class="form_cat border-radius box-shadow">
			<p class="chart_title">创伤患者院前急救转运时间</p>
       ...
       $(document).keydown(function(event) {
        ...
        function datagridshow(){
            ...
            $('#tableId').datagrid({
                ...
                striped: true,
                singleSelect: true,
                url: "edpcReport/queryYqjjzyRate_result.do",
                //idField: '1',
                loadMsg: '',
                queryParams: {
                    startDate: start,
