...
<head>
    <title>到达门/急诊科至完成FAST检查的时间(严重创伤病人）</title>
    <base href="<%=basePath%>">
...
// 			console.log(queryParams)
    ...
    function getData() {
        $('#tablelist').datagrid({
            title: '到达门/急诊科至完成FAST检查的时间(严重创伤病人）',
            nowrap: true,
            striped: true,
            singleSelect: true,
            rownumbers: true,
            toolbar: getToolbar(),
            url: '${baseurl}edpcReport/queryCsFastJcTime.do',
...
// 			console.log('seriesData', seriesData)
        series.push(new Series('急诊科至完成全身快速CT时间', seriesData))
...
<form id="reportform" action="${baseurl}edpcReport/exportCsFastJcTime.do" method="post">
    <!-- html的静态布局 -->
    <!-- 查询条件 -->
    <div class="m-b5">
...
<div class="chart_grp chartbox" id="chartbox">
    <div class="form_cat border-radius box-shadow">
        <p class="chart_title">急诊科至完成全身快速CT时间趋势图</p>
        <!-- <hr class="hr"/> -->
