...
// 			console.log(queryParams)
    ...
    function getData() {
        $('#tablelist').datagrid({
            title: '急诊科至完成全身快速CT时间趋势表',
            nowrap: true,
            striped: true,
            singleSelect: true,
            rownumbers: true,
            toolbar: getToolbar(),
            url: '${baseurl}edpcReport/queryCsFastCtTime.do',
...
<form id="reportform" action="${baseurl}edpcReport/exportCsFastCtTime.do" method="post">
    <!-- html的静态布局 -->
    <!-- 查询条件 -->
    <div class="m-b5">
