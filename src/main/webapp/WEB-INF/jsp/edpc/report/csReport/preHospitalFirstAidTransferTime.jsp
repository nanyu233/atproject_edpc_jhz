...
// 			console.log(queryParams)
    ...
    function getData() {
        $('#tablelist').datagrid({
            ...
            rownumbers: true,
            toolbar: getToolbar(),
            url: '${baseurl}edpcReport/queryPreHospitalFirstAidTransferTime.do',
...
// 			console.log('rows', rows);
        ...
        $.each(rows, function(ind, val) {
            ...
            seriesData.push(new SeriesData(val.yarmon, val.avgtime))
        });
// 			console.log('seriesData', seriesData)
        series.push(new Series('院前急救转运时间', seriesData))
...
<form id="reportform" action="${baseurl}edpcReport/exportPreHospitalFirstAidTransferTime.do" method="post">
    <!-- html的静态布局 -->
    <!-- 查询条件 -->
    <div class="m-b5">
...
<div class="chart_grp chartbox" id="chartbox">
    <div class="form_cat border-radius box-shadow">
        <p class="chart_title">院前急救转运时间趋势图</p>
        <!-- <hr class="hr"/> -->
