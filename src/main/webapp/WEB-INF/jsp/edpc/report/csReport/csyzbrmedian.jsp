...
// 			console.log(queryParams)
		...
		function getData() {
			$('#tablelist').datagrid({
				...
				rownumbers: true,
				toolbar: getToolbar(),
				url: '${baseurl}edpcReport/queryCsyzbrMedian_result.do',
...
// 			console.log('seriesData', seriesData)
			series.push(new Series('严重创伤患者数', seriesData))
...
// 				colors: ['#2f7ed8', '#0d233a', '#8bbc21', '#910000', '#1aadce', '#492970', '#f28f43', '#77a1e5', '#c42525', '#a6c96a'],
	...
	<form id="reportform" action="${baseurl}edpcReport/exportTruamaTrendSubmit.do" method="post">
		<!-- html的静态布局 -->
		<!-- 查询条件 -->
		<div class="m-b5">
	...
	<div class="chart_grp chartbox" id="chartbox">
		<div class="form_cat border-radius box-shadow">
			<p class="chart_title">严重创伤病人数量趋势图</p>
			<!-- <hr class="hr"/> -->
