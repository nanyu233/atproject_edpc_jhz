...
// 			console.log(queryParams)
    ...
    function getData() {
        $('#tablelist').datagrid({
            ...
            rownumbers: true,
            toolbar: getToolbar(),
            url: '${baseurl}edpcReport/queryCsMjzTingliuTime.do',
...
// 			console.log('seriesData', seriesData)
        series.push(new Series('门/急诊科停留时间', seriesData))
...
<form id="reportform" action="${baseurl}edpcReport/exportCsMjzTingliuTime.do" method="post">
    <!-- html的静态布局 -->
    <!-- 查询条件 -->
    <div class="m-b5">
...
<div class="chart_grp chartbox" id="chartbox">
    <div class="form_cat border-radius box-shadow">
        <p class="chart_title">门/急诊科停留时间</p>
        <!-- <hr class="hr"/> -->
