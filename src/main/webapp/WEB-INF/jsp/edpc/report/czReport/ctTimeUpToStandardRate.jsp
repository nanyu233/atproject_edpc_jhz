...
<head>
	<title>从入院到开始头颅CT时间<25分钟的比例</title> 
...
<body class="Overtime">
	<form id="querymqform" action="edpcReport/exportExcelSubmit.do"
		...
		<input type="hidden" name="fileName" value="从入院到开始头颅CT时间小于25分钟的比例">
		<input type="hidden" name="reportTypeFlag" value="DYTOCT">
		<input type="hidden" name="claFlg" value="true">
	</form>
	<div class="chart_grp chartbox">
		<div class="form_cat border-radius box-shadow">
			<p class="chart_title">从入院到开始头颅CT时间<25分钟的比例</p>
	...
	<script type="text/javascript">
       ...
       $(document).keydown(function(event) {
        ...
        function datagridshow(){
            ...
            $('#dtoblist').datagrid({
                title: "从入院到开始头颅CT时间<25分钟的比例",
                nowrap: true,
                //view: transposedview,
                striped: true,
                singleSelect: true,
                url: "edpcReport/ctTimeUpToStandardRate_result.do",
                //idField: '1',
                loadMsg: '',
                queryParams: {
                    startDate: start,
