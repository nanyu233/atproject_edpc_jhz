...
<head>
	<title>急性缺血性卒中患者，从入院到开始动脉取栓时间</title> 
...
<body class="Overtime">
	...
	<div class="chart_grp chartbox">
		<div class="form_cat border-radius box-shadow">
			<p class="chart_title">急性缺血性卒中患者，从入院到开始动脉取栓时间</p>
	...
	<script type="text/javascript">
       ...
       $(document).keydown(function(event) {
        ...
        function initChart(){
            ...
            chart = Highcharts.chart('container', {
                ...
                exporting: {
                    ...
                    width: 1200, //导出报表的宽度  
                    filename: '急性缺血性卒中患者，从入院到开始动脉取栓时间',
                    buttons: {
                        contextButton: {
                            // 自定义导出菜单项目及顺序
                            menuItems: [
        ...
        function datagridshow(){
            ...
            $('#dtoblist').datagrid({
                title: "急性缺血性卒中患者，从入院到开始动脉取栓时间",
                nowrap: true,
                //view: transposedview,
                striped: true,
                singleSelect: true,
                url: "edpcReport/d2dmqs_result.do",
                //idField: '1',
                loadMsg: '',
                queryParams: {
                    startDate: start,
