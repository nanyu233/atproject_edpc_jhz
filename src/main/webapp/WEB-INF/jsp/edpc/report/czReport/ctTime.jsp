...
<body class="Overtime">
	<form id="querymqform" action="edpcReport/exportExcelSubmit.do"
		...
		<input type="hidden" name="fileName" value="从入院到开始头颅CT时间">
...
<%--		<input type="hidden" name="claFlg" value="true">--%>
	...
	<div class="chart_grp chartbox">
		<div class="form_cat border-radius box-shadow">
			<p class="chart_title">从入院到开始头颅CT时间</p>
       ...
       $(document).keydown(function(event) {
        ...
        function datagridshow(){
            ...
            $('#dtoblist').datagrid({
                ...
                striped: true,
                singleSelect: true,
                url: "edpcReport/ctTime_result.do",
                //idField: '1',
                loadMsg: '',
                queryParams: {
                    startDate: start,
                ...
                onLoadSuccess: function(data) {
                	...
                	var dataArray = data.rows;
                        ...
                        for (var i = 0; i < dataArray.length; i++) {
                        	...
                        	seriesData.push(dataArray[i].avgTime==0?'-':dataArray[i].avgTime);
