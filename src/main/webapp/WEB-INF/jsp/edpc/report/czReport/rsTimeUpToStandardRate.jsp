...
<head>
	<title>缺血性卒中患者在溶栓时间窗内接受静脉溶栓患者的比例</title> 
...
<body class="Overtime">
	...
	<div class="chart_grp chartbox">
		<div class="form_cat border-radius box-shadow">
			<p class="chart_title">缺血性卒中患者在溶栓时间窗内接受静脉溶栓患者的比例</p>
	...
	<script type="text/javascript">
       ...
       $(document).keydown(function(event) {
        ...
        function initChart(){
            ...
            chart = Highcharts.chart('container', {
                ...
                exporting: {
                    ...
                    width: 1200, //导出报表的宽度  
                    filename: '缺血性卒中患者在溶栓时间窗内接受静脉溶栓患者的比例',
                    buttons: {
                        contextButton: {
                            // 自定义导出菜单项目及顺序
                            menuItems: [
        ...
        function datagridshow(){
            ...
            $('#dtoblist').datagrid({
                title: "缺血性卒中患者在溶栓时间窗内接受静脉溶栓患者的比例",
                nowrap: true,
                //view: transposedview,
                striped: true,
                singleSelect: true,
                url: "edpcReport/rsTimeUpToStandardRate_result.do",
                //idField: '1',
                loadMsg: '',
                queryParams: {
                    startDate: start,
