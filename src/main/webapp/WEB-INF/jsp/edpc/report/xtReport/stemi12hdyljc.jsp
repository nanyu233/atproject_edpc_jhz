...
<head>
	<title>STEMI患者发病后12小时内获得首次医疗接触的比例</title>
	<base href="<%=basePath%>" >
...
<body class="Overtime">
	<form id="querymqform" action="edpcReport/getStemi12Hdyljc_export.do"
		method="post">
		<!-- html的静态布局 -->
		<!-- 查询条件 -->
		<div class="m-b5">
	...
	<div class="chart_grp chartbox">
		<div class="form_cat border-radius box-shadow">
			<p class="chart_title">STEMI患者发病后12小时内获得首次医疗接触的比例</p>
	...
	<script type="text/javascript">
       ...
       $(document).keydown(function(event) {
        ...
        function initChart(){
            ...
            chart = Highcharts.chart('container', {
                ...
                exporting: {
                    ...
                    width: 1200, //导出报表的宽度  
                    filename: 'STEMI患者发病后12小时内获得首次医疗接触的比例',
                    buttons: {
                        contextButton: {
                            // 自定义导出菜单项目及顺序
                            menuItems: [
        ...
        var columns_v = [[
            {
                ...
                field: 'tnumb',
                title: 'STEMI患者发病后12小时内获得首次医疗接触的人数',
                width: getWidth(0.2)
            },  {
                field: 'patNumb',
                title: 'STEMI患者总数',
        ...
        function datagridshow(){
            ...
            $('#dtoblist').datagrid({
                title: "STEMI患者发病后12小时内获得首次医疗接触的比例",
                nowrap: true,
                //view: transposedview,
                striped: true,
                singleSelect: true,
                url: "edpcReport/getStemi12Hdyljc_result.do",
                //idField: '1',
                loadMsg: '',
                queryParams: {
                    startDate: start,
        ...
        function medianquery() {
            ...
            if(publicFun.searchTime(start,end)){
           	 	$('#dtoblist').datagrid('load', {"startDate":start,"endDate":end, reportTypeFlag: 'CTA'});
            }
        }
    </script>
</body>
