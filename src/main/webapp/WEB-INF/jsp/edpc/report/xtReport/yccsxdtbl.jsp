...
<body class="Overtime">
	...
	<div class="chart_grp chartbox">
		<div class="form_cat border-radius box-shadow">
			<p class="chart_title">经救护车（包括呼叫本地120入院及由非PCI医院转诊患者）入院的STEMI患者，从急救现场或救护车远程传输心电图至胸痛中心的比例不低于30%</p>
	...
	<script type="text/javascript">
       ...
       $(document).keydown(function(event) {
        ...
        function datagridshow(){
            ...
            $('#tableId').datagrid({
                title: "120来院的STEMI患者远程心电图传输比例",
                nowrap: true,
                //view: transposedview,
                striped: true,
                singleSelect: true,
                url: "edpcReport/yccsxdtbl_result.do",
                //idField: '1',
                loadMsg: '',
                queryParams: {
                    startDate: start,
