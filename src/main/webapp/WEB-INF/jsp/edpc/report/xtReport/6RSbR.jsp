...
<head>
	<title>卒中病人发病6小时内溶栓的病人的比例</title>
	<base href="<%=basePath%>" >
...
<body class="Overtime">
	<form id="querymqform" action="edpcReport/get6RSbR_export.do"
		method="post">
		<!-- html的静态布局 -->
		<!-- 查询条件 -->
		<div class="m-b5">
	...
	<div class="chart_grp chartbox">
		<div class="form_cat border-radius box-shadow">
			<p class="chart_title">卒中病人发病6小时内溶栓的病人的比例</p>
	...
	<script type="text/javascript">
       ...
       $(document).keydown(function(event) {
        ...
        function datagridshow(){
            ...
            $('#dtoblist').datagrid({
                title: "卒中病人发病6小时内溶栓的病人的比例",
                nowrap: true,
                //view: transposedview,
                striped: true,
                singleSelect: true,
                url: "edpcReport/get6RSbR_result.do",
                //idField: '1',
                loadMsg: '',
                queryParams: {
                    startDate: start,
