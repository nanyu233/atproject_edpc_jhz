...
<body class="Overtime">
	...
	<div class="chart_grp chartbox">
		<div class="form_cat border-radius box-shadow">
			<p class="chart_title">自行来院且接受PPCI治疗的STEMI患者，绕行CCU从急诊科直接送入导管室的比例不低于75%</p>
	...
	<script type="text/javascript">
       ...
       $(document).keydown(function(event) {
        ...
        function datagridshow(){
            ...
            $('#tableId').datagrid({
                title: "自行来院且接受PPCI治疗的STEMI患者，绕行CCU从急诊科直接送入导管室的比例不低于75%",
                nowrap: true,
                //view: transposedview,
                striped: true,
                singleSelect: true,
                url: "edpcReport/rxccubl_result.do",
                //idField: '1',
                loadMsg: '',
                queryParams: {
                    startDate: start,
