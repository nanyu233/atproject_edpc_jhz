...
// 			console.log(queryParams)
		...
		function getData() {
			$('#tablelist').datagrid({
				...
				rownumbers: true,
				toolbar: getToolbar(),
				url: '${baseurl}edpcReport/querycpcpie_result.do',
				onLoadSuccess: function(data) {
// 					console.log('data', data)
					loadChart(data.rows, "pie");
					// 增加合计人数
...
// 			console.log('seriesData', seriesData)
			series.push(new Series('胸痛病例统计', seriesData))
...
// 				colors: ['#2f7ed8', '#0d233a', '#8bbc21', '#910000', '#1aadce', '#492970', '#f28f43', '#77a1e5', '#c42525', '#a6c96a'],
				...
				tooltip: {
					...
					pointFormat: '<span style="font-weight: bold;color: {point.color}">{point.name}: {point.y}例 ({point.percentage:.2f}%)</span>'
				},
				plotOptions: {
					pie: {
	...
	<form id="reportForm" action="${baseurl}edpcReport/exportCpcPieSubmit.do" method="post">
		<!-- html的静态布局 -->
		<!-- 查询条件 -->
		<div class="m-b5">
