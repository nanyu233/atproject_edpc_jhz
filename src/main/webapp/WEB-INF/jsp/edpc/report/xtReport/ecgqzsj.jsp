...
<body class="Overtime">
	<form id="querymqform" action="edpcReport/exportXtReportSubmit.do"
		...
		<input type="hidden" name="reportTypeFlag" value="ECG_QZ">
	</form>
       ...
       $(document).keydown(function(event) {
        ...
        function medianquery() {
            ...
            if(publicFun.searchTime(start,end)){
           	 	$('#dtoblist').datagrid('load', {"startDate":start,"endDate":end, reportTypeFlag: 'ECG_QZ'});
            }
        }
    </script>
</body>
