...
<body class="Overtime">
	<form id="querymqform" action="edpcReport/xtReportExport.do"
		...
		<input type="hidden" name="reportTypeFlag" value="RSHZYBL">
	</form>
	<div class="chart_grp chartbox">
		<div class="form_cat border-radius box-shadow">
			<p class="chart_title">溶栓后患者（包含网络医院，120及本院）24小时内早期造影的比例不低于75%</p>
	...
	<script type="text/javascript">
       ...
       $(document).keydown(function(event) {
        ...
        function initChart(){
            ...
            chart = Highcharts.chart('container', {
                ...
                exporting: {
                    ...
                    width: 1200, //导出报表的宽度  
                    filename: '溶栓后患者（包含网络医院，120及本院）24小时内早期造影的比例不低于75%',
                    buttons: {
                        contextButton: {
                            // 自定义导出菜单项目及顺序
                            menuItems: [
        ...
        function datagridshow(){
            ...
            $('#tableId').datagrid({
                title: "溶栓后患者24小时内早期造影的比例",
                nowrap: true,
                //view: transposedview,
                striped: true,
                singleSelect: true,
                url: "edpcReport/rshzybl_result.do",
                //idField: '1',
                loadMsg: '',
                queryParams: {
                    startDate: start,
