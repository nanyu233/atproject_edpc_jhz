...
<head>
    <title>发病12小时内诊断为STEMI的患者给予溶栓或介入的占比</title>
    <base href="<%=basePath%>" >
...
<body class="Overtime">
<form id="querymqform" action="edpcReport/getStemiRSorJR_export.do"
      method="post">
    <!-- html的静态布局 -->
    <!-- 查询条件 -->
    <div class="m-b5">
...
<div class="chart_grp chartbox">
    <div class="form_cat border-radius box-shadow">
        <p class="chart_title">发病12小时内诊断为STEMI的患者给予溶栓或介入的占比</p>
...
<script type="text/javascript">
    ...
    function initChart(){
        ...
        chart = Highcharts.chart('container', {
            ...
            exporting: {
                ...
                width: 1200, //导出报表的宽度
                filename: '发病12小时内诊断为STEMI的患者给予溶栓或介入的占比',
                buttons: {
                    contextButton: {
                        // 自定义导出菜单项目及顺序
                        menuItems: [
    ...
    function datagridshow(){
        ...
        $('#dtoblist').datagrid({
            title: "发病12小时内诊断为STEMI的患者给予溶栓或介入的占比",
            nowrap: true,
            //view: transposedview,
            striped: true,
            singleSelect: true,
            url: "edpcReport/getStemiRSorJR_result.do",
            //idField: '1',
            loadMsg: '',
            queryParams: {
                startDate: start,
