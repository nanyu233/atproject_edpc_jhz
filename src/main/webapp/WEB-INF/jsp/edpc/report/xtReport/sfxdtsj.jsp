...
<body class="Overtime">
	<form id="querymqform" action="edpcReport/exportXtReportSubmit.do"
		...
		<input type="hidden" name="reportTypeFlag" value="FIRST_ECG">
	</form>
	<div class="chart_grp chartbox">
		<div class="form_cat border-radius box-shadow">
			<p class="chart_title"> 对于自行来院或拨打本地120经救护车入院的所有急性胸痛患者，缩短了从首次医疗接触到完成首份心电图时间，且要求月平均小于10分钟。</p>
       ...
       $(document).keydown(function(event) {
        ...
        function medianquery() {
            ...
            if(publicFun.searchTime(start,end)){
           	 	$('#dtoblist').datagrid('load', {"startDate":start,"endDate":end, reportTypeFlag: 'FIRST_ECG'});
            }
        }
    </script>
</body>
