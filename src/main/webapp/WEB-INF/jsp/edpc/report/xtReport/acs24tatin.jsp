...
<head>
	<title>ACS患者FMC后24小时内接受他汀类药物的比例</title>
	<base href="<%=basePath%>" >
...
<body class="Overtime">
	...
	<div class="chart_grp chartbox">
		<div class="form_cat border-radius box-shadow">
			<p class="chart_title">ACS患者FMC后24小时内接受他汀类药物的比例</p>
	...
	<script type="text/javascript">
       ...
       $(document).keydown(function(event) {
        ...
        function initChart(){
            ...
            chart = Highcharts.chart('container', {
                ...
                exporting: {
                    ...
                    width: 1200, //导出报表的宽度  
                    filename: 'ACS患者FMC后24小时内接受他汀类药物的比例',
                    buttons: {
                        contextButton: {
                            // 自定义导出菜单项目及顺序
                            menuItems: [
        ...
        function datagridshow(){
            ...
            $('#tableId').datagrid({
                title: "ACS患者FMC后24小时内接受他汀类药物的比例",
                nowrap: true,
                //view: transposedview,
                striped: true,
                singleSelect: true,
                url: "edpcReport/acs24tatin_result.do",
                //idField: '1',
                loadMsg: '',
                queryParams: {
                    startDate: start,
