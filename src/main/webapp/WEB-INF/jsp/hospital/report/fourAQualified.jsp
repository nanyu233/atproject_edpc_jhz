...
<body class="median">
  ...
  <script type="text/javascript">
    ...
    function queryPie() {
      ...
      publicFun.httpServer({url: '${baseurl}report/getFourA.do'}, data, function (data) { drawChart(data)})
    }
    ...
    function loadTable() {
      ...
      $('#medianList').datagrid({
        ...
        striped: true,
        singleSelect: true,
        url: "${baseurl}report/queryfourA_result.do",
        idField: 'mdate',
        queryParams: {
          startdate: start,
          enddate: end,
  ...
  <form id="medianform" action="${baseurl}report/exportFourASubmit.do" method="post">
    <!-- html的静态布局 -->
    <!-- 查询条件 -->
    <div class="m-b5">
  ...
  <div class="chart_grp chartbox">
    <div class="form_cat border-radius box-shadow">
      <p class="chart_title">IVa级患者接诊达标率（%）</p>
