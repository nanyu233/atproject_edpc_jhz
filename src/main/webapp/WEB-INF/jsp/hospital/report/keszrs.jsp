...
<body class="keszrs">
  ...
  <script type="text/javascript">
    ...
    function getData(objParam) {
      $('#tabList').datagrid({
        ...
        singleSelect: true,
        toolbar: toolCus(),
        url: "${baseurl}report/zjzyrs_resultss.do",
    ...
    function btnExport(exportType) {
      if (exportType == 'export') {
        publicFun.httpServer({ url: '${baseurl}report/zjzyrsSubmit.do' }, generateParam(), function (res) {
  ...
  <div class="chart_grp chartbox">
    <div class="form_cat border-radius box-shadow">
      <p class="chart_title">住院科室收住人数统计报表</p>
