...
<body class="brbzxgtjt">
  ...
  <script type="text/javascript">
    ...
    function loadChart(chartDate, chartsType) {
      ...
      var seriesOne,seriesTwo = null;
      var seriesDataOne = new Array();
      var seriesDataTwo = new Array();
      ...
      seriesOne = new Person('诊间就诊', seriesDataOne, "male");
      seriesArr.push(seriesOne);
      seriesTwo = new Person('留抢', seriesDataTwo, "male");
      seriesArr.push(seriesTwo);
      ...
      $('#tabList').datagrid({
        ...
        toolbar: [{
          ...
          handler: function () {
            _confirm('确定导出吗？', null, function () {
              publicFun.httpServer({ url: '${baseurl}report/export24hjzfb_result.do' }, objParam, function (res) {
        ...
        onLoadSuccess: function (data) {
          ...
          $('#tabList').datagrid('appendRow', {
            queryType: '<b>合计（人）:</b>',
            zjcounts: compute("zjcounts", data),
            lqcounts: compute("lqcounts", data)
          });
        }
      });
    }
