  ...
  var vm = new Vue({
    ...
    methods: {
      getParentList: function () {
        this.getSecondMsg()
        this.getgetMsglist('xtxmzbList',e_xtCod)
      },
      getgetMsglist(listName,cod) {
        var getMsgList = publicFun.getDict('XT_BQPG_COD');
        ...
        vm.getMsg[listName] = JSON.parse(JSON.stringify(getMsgList));
      },
      getSecondMsg: function () {
        var _list = publicFun.getDict('XT_BQPGMX_COD');
