...
<div class="left_part">
    ...
    <div class="left_center">
        <form id="diacrisis" name="hceptform" action="${baseurl}report/exporthspemgSubmit.do" method="post" class="blform">
            <p><img src="images/hems/index/pie.png" class="titleimg" />MPDS统计</p>
    ...
    <div class="right_top">
        <div class="titleLine">
            <div class="left">
                ...
                <p class="textBox">严重患者</p>
            </div>
            <div class="right">
                <p class="number JZHZ_right"></p>
                <p class="textBox">多学科救治启动次数</p>
            </div>
        </div>
        <div class="titleLine">
            <div class="left">
                <p class="number RXHZ_right"></p>
                <p class="textBox">创伤患者</p>
            </div>
            <div class="right">
                <p class="number ZXLY_right"></p>
                <p class="textBox">严重创伤抢救成功率</p>
            </div>
        </div>
    </div>
