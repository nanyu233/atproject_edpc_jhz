...
<body class="easyui-layout querycompctluser" scroll="no">
    <script type="text/javascript">
     //父页面的enter按键默认功能取消
      $(document).keydown(function(event) {
	    ...
	    var rootnode;
	    $(function() {
	    	$(".compctluser").parent().css({"margin-left":"2px","margin-top":"2px"});
	        init();
	    });
	        ...
	        if (!rootnode) {
	            ...
	            if (rootnode) {
	                ...
	                if (node.attributes && node.attributes.url) {
	                    var url = "${baseurl}" + node.attributes.url + "?sysid=" + node.id+"&moduleid=${moduleid}";
    ...
    <div class="compctluser" id="west" title="用户管理" split="true" region="west" hide="true">
        <div class="tree-head">
            <div class="tree-btn">
