...
<body>
  ...
  <form id="pwdform" action="${baseurl}user/savePassword.do" method="post" class="form">
    <input type="hidden" name="dstuserCustom.usrno" value="${dstuserCustom.usrno}" />
    <table>
      </tbody>
      <tr>
        <th>用户名：</th>
        <td>
          <input type="text" class="input-base li-input-s" id="user_usrname" name="dstuserCustom.usrname" value="${dstuserCustom.usrname}"
            readonly="readonly" />
        </td>
      </tr>
      <tr>
