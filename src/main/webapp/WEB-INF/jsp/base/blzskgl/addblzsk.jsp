...
<body>
	<form class="form" id="hspblzskform"
		...
		<input type="hidden" name="hspFavoritesInfCustom.ksdm" value="*" />
		<table>
			<colgroup>
				<col width="23%" />
				<col />
			...
			<tbody>
				<tr>
					...
					<td><input class="input-base total-right" type="text"
						name="hspFavoritesInfCustom.title" maxlength="50" /></td>
				</tr>
				<tr>
					<th>模板类型：</th>
					<td>
				...
				<tr>
					...
					<td><textarea style="width: 230px; height: 120px"
							name="hspFavoritesInfCustom.content" maxlength="280"></textarea>
					</td>
				</tr>
				<tr>
					<th>排序：</th>
					...
					<td colspan="2" class="last_td">
						<div class="center grp_btn">
							<a class="easyui-linkbutton" iconCls="icon-ok" id="submitbtn"
								onclick="addHspBlzsk()">确定</a> <a class="easyui-linkbutton"
	...
	<script type="text/javascript">
		//病历知识库保存
		function addHspBlzsk() {
			if (validateForm()) {
				jquerySubByFId('hspblzskform', inserthspblzsk_callback, null, "json");
			}
		}
		...
		//新增的回调函数
		function inserthspblzsk_callback(data) {
			message_alert(data);
