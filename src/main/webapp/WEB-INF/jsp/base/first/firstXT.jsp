...
<body class="easyui-layout first" scroll="no">
	<div border="false" split="false" region="north" class="top-bg">
        ...
        </a> --> <a href="javascript:queryOutime()"> <span class="isShowMessage">候诊提醒 <img
						src="images/hems/first/tip_icon.png" class="msgIcon" id="msg_alert" /> <span class="bg-theme" id="notifyMsg">无</span>
				</span>
			</a> <img class="iconfirst iconnone" src="images/hems/first/personal2.png"><span class="showUser">${activeUser.usrname}(${activeUser.usrno}),欢迎您！</span>
	...
	<script type="text/javascript">
	    ...
	    function queryOutime() {
	      parent.opentabwindow('候诊患者查询', 'his/toOutime.do?moduleid=' + 'c408dbf33d304f4e826761380d8a044f');
	    }
